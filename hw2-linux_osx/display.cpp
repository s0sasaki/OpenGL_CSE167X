...
void display()
{
  ...
  if (numused) {
    ...
    //glUniform4fv(lightposn,1,&lightransf[0]);
  	//glUniform4fv(lightcolor,1,&lightcolor[0]);
    GLuint light0posn;
    GLuint light0color;
    glUniform4fv(light0posn,1,lightransf);
    glUniform4fv(light0color,1,lightcolor);
  ...
  //modelview = transf; //sasaki //TODO これをUncommentできるように取り組む必要あり
